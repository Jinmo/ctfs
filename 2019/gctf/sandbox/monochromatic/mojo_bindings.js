...
(function() {
  ...
  Decoder.prototype.decodeString = function() {
    ...
    var ey=new Uint8Array(this.buffer.arrayBuffer, base, numberOfElements)
    return ey
...
(function() {
  ...
  function encodeUtf8String(str, outputBuffer) {
    if(str instanceof ArrayBuffer) {
      const utf8Buffer = new Uint8Array(str);
...
(function() {
  ...
  RunMessageParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.input = mutator_.mutateUnion(this.input, mojo.interfaceControl.RunInput, false);
    }
    return this;
  };
  ...
  RunResponseMessageParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.output = mutator_.mutateUnion(this.output, mojo.interfaceControl.RunOutput, true);
    }
    return this;
  };
  ...
  RunOrClosePipeMessageParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.input = mutator_.mutateUnion(this.input, mojo.interfaceControl.RunOrClosePipeInput, false);
    }
    return this;
  };
    ...
    var mutators = [
      {
        ...
        mutator: function(val) { return mutator_.mutateStruct(val.queryVersion, mojo.interfaceControl.QueryVersion, false); },
      },
      {
        field: "flushForTesting",

        mutator: function(val) { return mutator_.mutateStruct(val.flushForTesting, mojo.interfaceControl.FlushForTesting, false); },
      },
    ];
    ...
    var mutators = [
      {
        ...
        mutator: function(val) { return mutator_.mutateStruct(val.queryVersionResult, mojo.interfaceControl.QueryVersionResult, false); },
      },
    ];
    ...
    var mutators = [
      {
        ...
        mutator: function(val) { return mutator_.mutateStruct(val.requireVersion, mojo.interfaceControl.RequireVersion, false); },
      },
    ];
...
(function() {
  ...
  RunOrClosePipeMessageParams.generate = function(generator_) {
    var generated = new RunOrClosePipeMessageParams;
    generated.input = generator_.generateUnion(mojo.pipeControl.RunOrClosePipeInput, false);
    return generated;
  };

  RunOrClosePipeMessageParams.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.input = mutator_.mutateUnion(this.input, mojo.pipeControl.RunOrClosePipeInput, false);
    }
    return this;
  };
  RunOrClosePipeMessageParams.prototype.getHandleDeps = function() {
  ...
  DisconnectReason.generate = function(generator_) {
    var generated = new DisconnectReason;
    generated.customReason = generator_.generateUint32();
    generated.description = generator_.generateString(false);
    return generated;
  };

  DisconnectReason.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.customReason = mutator_.mutateUint32(this.customReason);
    }
    if (mutator_.chooseMutateField()) {
  ...
  DisconnectReason.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  DisconnectReason.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  DisconnectReason.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  PeerAssociatedEndpointClosedEvent.generate = function(generator_) {
    var generated = new PeerAssociatedEndpointClosedEvent;
    generated.id = generator_.generateUint32();
    generated.disconnectReason = generator_.generateStruct(mojo.pipeControl.DisconnectReason, true);
    return generated;
  };

  PeerAssociatedEndpointClosedEvent.prototype.mutate = function(mutator_) {
    if (mutator_.chooseMutateField()) {
      this.id = mutator_.mutateUint32(this.id);
    }
    if (mutator_.chooseMutateField()) {
      this.disconnectReason = mutator_.mutateStruct(this.disconnectReason, mojo.pipeControl.DisconnectReason, true);
    }
    return this;
  };
  PeerAssociatedEndpointClosedEvent.prototype.getHandleDeps = function() {
    var handles = [];
    return handles;
  };

  PeerAssociatedEndpointClosedEvent.prototype.setHandles = function() {
    this.setHandlesInternal_(arguments, 0);
  };
  PeerAssociatedEndpointClosedEvent.prototype.setHandlesInternal_ = function(handles, idx) {
    return idx;
  };
  ...
  RunOrClosePipeInput.generate = function(generator_) {
    ...
    var generators = [
      {
        field: "peerAssociatedEndpointClosedEvent",

        generator: function() { return generator_.generateStruct(mojo.pipeControl.PeerAssociatedEndpointClosedEvent, false); },
      },
    ];
    ...
    var mutators = [
      {
        ...
        mutator: function(val) { return mutator_.mutateStruct(val.peerAssociatedEndpointClosedEvent, mojo.pipeControl.PeerAssociatedEndpointClosedEvent, false); },
      },
    ];
