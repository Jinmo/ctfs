...
(function() {
  ...
  Origin.generate = function(generator_) {
    ...
    generated.nonceIfOpaque = generator_.generateStruct(mojoBase.mojom.UnguessableToken, true);
    return generated;
  };
  ...
  Origin.prototype.mutate = function(mutator_) {
    ...
    if (mutator_.chooseMutateField()) {
      this.nonceIfOpaque = mutator_.mutateStruct(this.nonceIfOpaque, mojoBase.mojom.UnguessableToken, true);
    }
    return this;
  };
